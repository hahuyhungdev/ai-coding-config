...
from .setup import configure_project_assistants, setup_claude, setup_codex, setup_agy, setup_cli_wrapper
...
__all__ = [
    ...
    # Setup
    'configure_project_assistants', 'setup_claude', 'setup_codex', 'setup_agy', 'setup_cli_wrapper',
    # MCP
