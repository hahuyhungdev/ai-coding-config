...
from .setup import configure_project_assistants, setup_claude, setup_codex, setup_gemini, setup_cli_wrapper
from .uninstall import uninstall_global, uninstall_project
