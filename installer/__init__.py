...
from .setup import configure_project_assistants, setup_claude, setup_codex, setup_cli_wrapper, uninstall_global, uninstall_project, show_status
...
__all__ = [
    ...
    # Setup
    'configure_project_assistants', 'setup_claude', 'setup_codex', 'setup_cli_wrapper', 'uninstall_global', 'uninstall_project', 'show_status',
    # MCP
