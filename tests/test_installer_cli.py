...
"""
    ...
    def test_setup_agy_installs_context_budget_skill_and_removes_switch_account(self):
        ...
        cb_skill = skills_dir / "context-budget" / "SKILL.md"
        self.assertTrue(cb_skill.is_file())
        self.assertIn("name: context-budget", cb_skill.read_text())
