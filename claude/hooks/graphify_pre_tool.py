...
def graph_json_denial():
    return (
        ...
        "💡 TIP: Use the graphify CLI instead: `graphify query`, `graphify path`, "
        "`graphify explain`, or `graphify affected`. Existence probes like "
...
def graph_report_denial():
    return (
        ...
        "💡 TIP: Use a scoped `graphify query \"<specific question>\"` first. "
...
def graphify_skill_denial():
    return (
        ...
        "💡 TIP: Use the project instructions directly: `graphify query \"<specific question>\"`."
    )
...
def scratch_reader_denial():
    return (
        ...
        "💡 TIP: Use `graphify query \"<question>\"` first, then targeted reads of "
