          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <div className="h-6 bg-white/[0.04] rounded-lg overflow-hidden border border-white/[0.06] flex items-center">
                <div className="h-full bg-error/45 transition-all duration-500" style={{ width: '100%' }} />
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="h-6 bg-white/[0.04] rounded-lg overflow-hidden border border-white/[0.06] flex items-center">
                <div 
                  className="h-full bg-success/60 shadow-[0_0_12px_rgba(80,250,123,0.3)] transition-all duration-500" 
                  style={{ width: `${Math.max(4, (data.total_cost / Math.max(1, proEquivalentCost)) * 100)}%` }} 
                />
              </div>
            </div>
          </div>
