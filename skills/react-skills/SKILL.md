---
name: react-skills
description: REACT COMPONENT ARCHITECTURE & STATE OPTIMIZATION. Use for refactoring React components. Guidelines for compound components, state lifting, custom hooks, avoiding boolean props, performance (virtualization/memoization), and React 19 API migration.
origin: ECC
---
