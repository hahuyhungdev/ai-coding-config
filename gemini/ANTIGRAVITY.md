...
Load and delegate complex tasks to specialized agents under `~/.gemini/config/agents/` strictly following these lazy-loading and anti-abuse best practices:
